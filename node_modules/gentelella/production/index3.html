        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Knoble Industries!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-wrench"></i> Jobs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Job Board</a></li>
                      <li><a href="index.html">Post a Job</a></li>
                      <li><a href="index.html">My Job Posts</a></li>
                      <li><a href="index2.html">Active Jobs</a></li>
                      <li><a href="index3.html">Past Jobs</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-archive"></i> Contracts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Build a Contract</a></li>
                      <li><a href="index.html">Active Contracts</a></li>
                      <li><a href="index2.html">Past Contracts</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-credit-card"></i> Payments <span class="fa fa-chevron-down"></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Make a Payment</a></li>
                      <li><a href="index.html">Payments Received</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-flag-checkered"></i> Invoices <span class="fa fa-chevron-down"></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Create an Invoice</a></li>
                      <li><a href="index.html">Invoices Received</a></li>
                      <li><a href="index.html">Paid Invoices</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-database"></i> Reports <span class="fa fa-chevron-down"></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">HUD Reporting</a></li>
                      <li><a href="index.html">Financial Reports</a></li>
                      <li><a href="index.html">Leans</a></li>
                      <li><a href="index.html">Insurances</a></li>
                      <li><a href="index.html">Workmans Comp</a></li>
                      <li><a href="index.html">Bids</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-users"></i> My Subs </a> </li>
